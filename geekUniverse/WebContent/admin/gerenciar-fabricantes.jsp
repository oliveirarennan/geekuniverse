...
<html lang="pt-br">
  <head>
    ...
    <title>Gerenciar Fabricantess</title>
      ...
      <div class="container-fluid">
          <div class="row">
            <div class=" col-md-8 col-md-offset-2 col-sm-8 col-offset-2 col-xs-8 col-xs-offset-2 col-lg-8 col-lg-offset-2">
              <legend><center>Gerenciar Fabricantes</center></legend>
              <a href="cadastrar-fabricante.jsp" class="btn btn-warning btn-xs">Adicionar Fabricante</a><a href="index.jsp" class="btn btn-default btn-xs">Voltar</a>
              <br />
              <br />
              ...
              <table class="table">
              	...
              	<c:forEach var="fabricante" items="${fa.listar() }">
              		<tr>
              			...
              			<td><a href="../ServletEditarFabricante?id=${fabricante.id }" class="btn btn-primary btn-xs">Editar</a>  <a href="../ServletRemoverFabricante?id=${fabricante.id }" class="btn btn-danger btn-xs">remover</a>  </td>
              		</tr>
              		</c:forEach>
              	</tbody>
              </table>
