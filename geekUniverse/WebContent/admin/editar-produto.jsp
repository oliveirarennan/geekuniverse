			...
			<div class="container-fluid">
				<div class="row">
					<div
						...
						<legend>
							<center>Editar Produto</center>
						</legend>

						<form name="frmCadastrarProduto" id="frmCadastrarProduto"
							action="../ServletEditarProduto" method="POST"
										...
										<optgroup>
											<c:forEach var="categoria" items="${ca.listarAtivada() }">
												<option value="${categoria.id }"
													<c:if test="${categoria.id == produto.categoria.id }"><c:out value="selected"/></c:if>>${categoria.nome}</option>
											</c:forEach>
										</optgroup>
									</select>
								</div>
										...
										<optgroup>
											<c:forEach var="fabricante" items="${fa.listarAtivado() }">
												<option value="${fabricante.id }"
													<c:if test="${fabricante.id == produto.fabricante.id }"><c:out value="selected"/></c:if>>${fabricante.nome}</option>
											</c:forEach>
										</optgroup>
									</select>
								</div>
							...
							<div class="input-group">
								<label class="input-group-btn"> <span
									class="btn btn-warning"> Escolher Imagem <input
										type="file" accept="image/jpeg; image/png"
										style="display: none;" name="arquivo" id="arquivo">
								</span>
								</label>
								<div class="validateError">
									<input type="text" class="form-control" readonly name="imagem"
										id="imagem">
								</div>
							</div>
							<br />
